    ...
    return function e(t, r, n) {
        ...
        1: [function (e, t, r) {
            ...
            function p(e) {
                ...
                var s = [];
                var a = 16383;
                for (var f = 0, u = r - i; f < u; f += a) {
                    s.push(d(e, f, f + a > u ? u : f + a))
                }
                if (i === 1) {
                    t = e[r - 1];
                    o += n[t >> 2];
        ...
        3: [function (e, t, r) {
            (function (t) {
                ...
                var i = n.Buffer;
                var o = n.SlowBuffer;
                var s = n.kMaxLength || 2147483647;
                r.alloc = function e(t, r, n) {
        ...
        4: [function (e, t, r) {
            ...
            function p(e) {
                var t = e.length < 0 ? 0 : y(e.length) | 0;
                var r = a(t);
                for (var n = 0; n < t; n += 1) {
                    r[n] = e[n] & 255
                }
            ...
            function m(e, t) {
                ...
                if (X(e) || e instanceof ArrayBuffer) {
                    return e.byteLength
                }
                if (typeof e !== "string") {
                    e = "" + e
            ...
            f.prototype.writeIntLE = function e(t, r, n, i) {
                ...
                this[r] = t & 255;
                while (++s < n && (a *= 256)) {
                    if (t < 0 && f === 0 && this[r + s - 1] !== 0) {
                        f = 1
                    }
                    this[r + s] = (t / a >> 0) - f & 255
                }
                return r + n
            };
            ...
            f.prototype.fill = function e(t, r, n, i) {
                ...
                if (typeof t === "number") {
                    ...
                    var a = f.isBuffer(t) ? t : new f(t, i);
                    var u = a.length;
                    for (s = 0; s < n - r; ++s) {
                        this[s + r] = a[s % u]
                    }
        ...
        14: [function (e, t, r) {
            ...
            function l(e) {
                return c(e, s, "day") || c(e, o, "hour") || c(e, i, "minute") || c(e, n, "second") || e + " ms"
            }
        ...
        17: [function (e, t, r) {
            (function (e, r, n) {
                ...
                function s(t, i) {
                    ...
                    var s = new r.Uint8Array(t);
                    if (t > 0) {
                        o.getRandomValues(s)
                    }
                    var a = new n(s.buffer);
        ...
        18: [function (e, t, r) {
            ...
            for (var u = 0; u < f.length; u++) {
                var l = f[u];
                if (!c.prototype[l]) c.prototype[l] = a.prototype[l]
            }
        ...
        20: [function (e, t, r) {
            (function (r) {
                ...
                var p = e("./internal/streams/BufferList");
                var g;
                c.inherits(m, f);
                ...
                function w(t, r) {
                    ...
                    if (r instanceof o) this.objectMode = this.objectMode || !!t.readableObjectMode;
                ...
                function S(e, t) {
                    ...
                    if (e > t.highWaterMark) t.highWaterMark = C(e);
                ...
                m.prototype.read = function (e) {
                    ...
                    if (e === 0 && t.needReadable && (t.length >= t.highWaterMark || t.ended)) {
                        ...
                        if (t.length === 0 && t.ended) q(this);
                        else x(this);
                        return null
                    }
                    e = S(e, t);
                    if (e === 0 && t.ended) {
                        if (t.length === 0) q(this);
                        return null
                    }
                ...
                function A(e, t) {
                    var r = null;
                    if (!u.isBuffer(t) && typeof t !== "string" && t !== null && t !== undefined && !e.objectMode) {
            ...
            (function (r) {
                ...
                if (typeof Symbol === "function" && Symbol.hasInstance && typeof Function.prototype[Symbol.hasInstance] === "function") {
                    ...
                    Object.defineProperty(g, Symbol.hasInstance, {
                        value: function (e) {
                            if (p.call(this, e)) return true;
                            return e && e._writableState instanceof d
                        }
                    })
                } else {
                    p = function (e) {
                ...
                function g(t) {
                    o = o || e("./_stream_duplex");
                    if (!p.call(g, this) && !(this instanceof o)) {
                        return new g(t)
                    }
                ...
                g.prototype.uncork = function () {
                    ...
                    if (e.corked) {
                        e.corked--;
                        if (!e.writing && !e.corked && !e.finished && !e.bufferProcessing && e.bufferedRequest) T(this, e)
                    }
                };
                g.prototype.setDefaultEncoding = function e(t) {
                ...
                function m(e, t, r, n, i, o) {
                    ...
                    if (t.writing || t.corked) {
                        ...
                        t.lastBufferedRequest = new h(n, i, o);
                        if (f) {
                ...
                function T(e, t) {
                    ...
                    if (e._writev && r && r.next) {
                        ...
                        b(e, t, true, t.length, i, "", o.finish);
                        t.pendingcb++;
                ...
                g.prototype.end = function (e, t, r) {
                    ...
                    if (!n.ending && !n.finished) B(this, n, r)
                };
        ...
        25: [function (e, t, r) {
            ...
            function a(e) {
                var t = s(e);
                if (typeof t !== "string" && (n.isEncoding === o || !o(e))) throw new Error("Unknown encoding: " + e);
                return t || e
            }
            r.StringDecoder = f;
        ...
        "/": [function (e, t, r) {
            (function (r) {
                ...
                u.prototype.signal = function (e) {
                    ...
                    t._debug("signal()");
                    if (e.candidate) {
                        if (t._pc.remoteDescription) t._addIceCandidate(e.candidate);
